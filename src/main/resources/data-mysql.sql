...
--INSERT INTO flight_details (plane_id,course,gps_latitude,gps_longitude,is_actual_position,incoming_time,velocity,distance_traveled,flight_distance,flight_time,remaining_fuel,average_fuel_consumption) values (1,15,51,17,true,NOW(),800,3000,4000,435,9000,800);
